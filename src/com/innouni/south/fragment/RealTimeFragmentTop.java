 ...
 * @version 1.0.0
 */
public class RealTimeFragmentTop extends Fragment implements OnClickListener, OnItemClickListener {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		view = inflater.inflate(R.layout.fragment_realtime_data_top, container, false);
